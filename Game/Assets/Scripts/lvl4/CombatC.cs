...
public class CombatC : MonoBehaviour
{
    ...
    protected SpeechControlC speech;
    protected combatMode playerMode;

    void Start()
    {
        upperHandle = GameObject.Find("Panto").GetComponent<UpperHandle>();
        speech = GameObject.Find("GameControl").GetComponent<SpeechControlC>();
        nextFire = Time.time;
    ...
    {
        if(ammunition > 0){
            Vector3 aimDirection = GetComponent<PlayerMovementC>().GetAimDirection();
