...
public class EnemyC : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sfx = GameObject.Find("GameControl").GetComponent<SpeechControlC>();
    ...
    void FixedUpdate()
    {
        ...
        if (health <= 0)
        {
            //GameObject.Find("GameControl").GetComponent<SpeechControlC>().PlayClip(ENEMYDEATH);
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Weapon")){
            ...
            if (health > 50){
                ...
                StartCoroutine(GameObject.Find("GameControl").GetComponent<GameControlC>().RegisterEnemyDeath());
                Destroy(gameObject);
            }
        }
    }
